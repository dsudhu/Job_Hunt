(function(e, d) {
    function g(a) { a.hasOwnProperty("data-simple-scrollbar") || Object.defineProperty(a, "data-simple-scrollbar", new SimpleScrollbar(a)) }

    function l(a, b) {
        function c(a) { var c = a.pageY - e;
            e = a.pageY;
            h(function() { b.el.scrollTop += c / b.scrollRatio }) }

        function f() { a.classList.remove("ss-grabbed");
    ...
    function k() { for (var a = d.querySelectorAll("*[ss-container]"), b = 0; b < a.length; b++) g(a[b]) }
    var h = e.requestAnimationFrame || e.setImmediate || function(a) { return setTimeout(a, 0) };
    f.prototype = {
        moveBar: function(a) {
